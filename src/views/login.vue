<template >
  ...
  <div class="backg grid grid-cols-2 grid-flow-col gap-4">
    <div><img src="../assets/imgeflix.png"></div>
  <!-- <div class="bg-black h-screen w-full"> -->
    <form  @submit.prevent="login" class=" bg-white  mt-24 p-2 w-3/4 h-3/4 mar order-solid border-2  rounded-lg drop-shadow-2xl "> 
      <div id="label1" class=" pt-8 w-full text-center pb-2">
      <label for="username" class="block text-sm font-bold text-black">
    </label>
    <input  type="text"  class= "p-4 w-10/12 border-2 border-slate-400 placeholder-black " v-model="username" placeholder="Enter your name"/>
...
Login</button>
  ...
  <div class="registerlink p-4 mx-5 ml-12 ">
    ...
    <a href="../views/signup.vue" style="color:blue"> Register?</a></p>
  </div>
